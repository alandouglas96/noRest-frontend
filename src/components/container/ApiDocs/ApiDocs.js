...
const ApiDocs = ({ userApis, publicApis, match, location }) => {
  ...
  if (publicDetails && publicApis) currentApi = _.filter(publicApis, (api) => (api.api_name === apiName));
...
const url = '${process.env.REACT_APP_BACKEND_URL}/api/${currentApi.api_name}/recordID';
const options = {
  method: 'PUT',
  headers: {
    'API_KEY': '${currentApi.api_key}',
...
fetch(url, options)
  ...
  return (
    <div className="box">
      ...
      {publicDetails 
        ?
          /* DOCS FOR THE PUBLIC, ONLY GET REQUESTS*/
          <div className="ApiDocsBox">
            <div className="bigTitle">{currentApi.api_name} Public API Documentation</div>
          <div className="docs-title">Getting Started</div>
            ...
            <div className="body-text">
              The examples in this page already include the correct routes and data.
            ...
            {/* <--- Standard GET Request */}
              ...
              <div className="body-text">
                The basic action you can do with the API is to make a GET Request without
